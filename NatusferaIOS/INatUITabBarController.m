...
- (void)presentAuthAlertForSource:(INatPhotoSource)source {
    ...
    switch (source) {
        case INatPhotoSourceCamera:
            ...
            //alertMsg = NSLocalizedString(@"Please make sure Natusfera is turned on in Settings > Privacy > Camera",//M.Lujano:10/06/2016
        ...
        default:
            ...
            //alertMsg = NSLocalizedString(@"Please make sure Natusfera is turned on in Settings > Privacy > Photos", //M.Lujano:10/06/2016
...
- (void)makeAndShowFirstObsTooltip {
    ...
    makeFirstObsTooltip = [[INatTooltipView alloc] initWithTargetBarButtonItem: (UIBarButtonItem*) [self.tabBar.items objectAtIndex:OBSERVE_TAB_INDEX]
                                                hostView:self.view
